		...
		<div class="form-group">
			<label for="id">아이디:</label>
				<input type="text" class="form-control" name="id" id="id">
				 <input type="button" value="중복체크" onclick="idchk()" class="btn btn-dark"><br>
			<label for="pwd">비밀번호:</label>
				<input type="password" class="form-control" name="pass" id="pwd">
			<label for="name">이름:</label>
				<input type="text" class="form-control" name="name" id="name">
			<label for="gender">성별:</label>
				<lable class="radio-inline"></lable>
					<input type="radio" name="gender" checked value="1">남<label class="radio-inline"></label>
